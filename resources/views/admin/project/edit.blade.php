    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('admin.edit_project',['project'=>$project->id]) }}">
                    @csrf
                    ...
                    <div class="box-body">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="category" id="category">
                                    ...
                                    @foreach($categories as $category)
                                        <option value="{{ $category->id }}" {{ empty(old('category')) ? ($errors->has('category') ? '' : ($project->category_id == $category->id ? 'selected' : '')) :
                        ...
                        <div class="form-group {{ $errors->has('image') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                ...
                                @enderror
                                <br>
                                <img src="{{ asset($project->feature_image) }}" width="150px" alt="">
                            </div>
                        </div>
                        <div class="form-group {{ $errors->has('youtube_link') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Enter Youtube Link"
                                       name="youtube_link" value="{{ empty(old('youtube_link')) ? ($errors->has('youtube_link') ? '' : $project->youtube_link) : old('youtube_link') }}">
                        ...
                        <div class="form-group {{ $errors->has('project_location_link') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Enter Project Location Link"
                                       name="project_location_link" value="{{ empty(old('project_location_link')) ? ($errors->has('project_location_link') ? '' : $project->project_location_link) : old('project_location_link') }}">
                        ...
                        <div class="form-group {{ $errors->has('description') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control"  rows="15" name="description" id="editor" placeholder="Enter Description">{{ $project->description }}</textarea>
                                @error('description')
                                <span class="help-block">{{ $message }}</span>
                                @enderror
                            </div>
